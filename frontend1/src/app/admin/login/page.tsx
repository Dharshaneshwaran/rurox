    ...
    <div className="bg-surface text-on-surface min-h-screen flex overflow-hidden">
      ...
      <div className="hidden lg:flex lg:w-1/2 spine-gradient items-center justify-center p-12 relative overflow-hidden">
        ...
        <div className="z-10 max-w-md">
          <div className="mb-8">
            <h1 className="font-headline text-5xl font-extrabold text-white tracking-tighter mb-4">EduLogistics</h1>
          ...
          <div className="flex flex-col gap-6">
            <div className="flex items-start gap-4 p-4 rounded bg-white/5 border border-white/10">
              ...
              <div>
                ...
                <p className="text-stone-500 text-xs mt-1">Instant substitute matching across 40+ institutions.</p>
              </div>
            </div>
            <div className="flex items-start gap-4 p-4 rounded bg-white/5 border border-white/10">
              ...
              <div>
                ...
                <p className="text-stone-500 text-xs mt-1">Multi-factor authentication and role-based access control.</p>
              </div>
            </div>
          </div>
        </div>
        <div className="absolute bottom-8 left-12">
          <p className="font-label text-[10px] uppercase tracking-[0.2em] text-stone-600">© 2024 Architectural Ledger Systems</p>
        </div>
      </div>
      ...
      <main className="w-full lg:w-1/2 flex flex-col items-center justify-center p-6 sm:p-12 hero-gradient">
        <div className="w-full max-w-[400px] flex flex-col">
          ...
          <div className="lg:hidden mb-12 text-center">
            <h1 className="font-headline text-3xl font-extrabold text-inverse-surface tracking-tighter">EduLogistics</h1>
          ...
          <div className="flex items-center gap-4 mb-10 overflow-x-auto pb-2 scrollbar-hide">
            ...
            >
              <span className="font-label text-[11px] uppercase tracking-wider text-on-surface-variant">Teacher Portal</span>
          ...
          <div className="bg-surface-container-lowest p-8 rounded shadow-sm border border-surface-container-high relative">
            ...
            <div className="mt-8 pt-6 border-t border-surface-container-high text-center">
              <p className="font-body text-[10px] text-on-surface-variant leading-relaxed">
                Authorized Personnel Only. All session activities are logged for auditing and security compliance within the EduLogistics framework.
              </p>
            </div>
          </div>
        </div>
